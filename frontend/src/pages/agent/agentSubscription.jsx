...
const AgentSubscription = () => {
  const { isSubscriptionValid, subscription } = useOutletContext();
  ...
  const handlePayment = async (planId) => {
    try {
      ...
      const orderData = isSubscriptionValid ? data.order : data.data;
      ...
      const options = {
        ...
        name: "DreamHaven",
        description: "Agent Subscription Payment",
    ...
    <div className="p-6 md:p-10">
      ...
      <div className="mb-10">
        <h2 className="text-3xl font-black">
          Agent <span className="text-purple-500 font-light">Subscription</span>
        </h2>
        <p className="text-slate-500 text-sm mt-1">
          Choose a plan to unlock agent features.
        </p>
      </div>
          ...
          return (
            ...
            >
              ...
              <div className="text-sm text-slate-300 space-y-2 mb-8">
                <p>✔ Access Assigned Properties</p>
